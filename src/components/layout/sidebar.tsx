...
import { LayoutDashboard, ShoppingCart, Users, BarChart3, Settings, LogOut, Leaf } from 'lucide-react';
...
export function Sidebar() {
  ...
  const companyLinks = [
    ...
    { href: '/company/pos', icon: ShoppingCart, label: 'POS System' },
  ...
  return (
    <div className="w-64 h-full bg-white border-r flex flex-col p-4">
